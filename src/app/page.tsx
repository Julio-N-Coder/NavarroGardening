      ...
      >
        ...
        <div className={styles.services}>
          <article className={styles.service}>
            <span className={styles.bold}>Mowing:</span> Regular mowing is
            essential for a healthy and attractive lawn. We provide reliable,
            professional mowing services tailored to your lawn&apos;s specific
            needs.
          </article>
          <article className={styles.service}>
            <span className={styles.bold}>Trimming Hedges:</span> Well-trimmed
            hedges not only look good but also contribute to the overall health
            of the plants. Our experianced profesional has the skills and
            equipment to trim your hedges to perfection.
          </article>
          <article className={styles.service}>
            <span className={styles.bold}>Irrigation:</span> Proper watering is
            crucial for a thriving yard. We offer irrigation services to ensure
            your plants get the right amount of water they need to flourish
          </article>
          <article className={styles.service}>
            <span className={styles.bold}>Clean-ups:</span> Whether it&apos;s
            spring cleaning, preparing for winter, or maintaining a clean and
            tidy yard year-round, We can handle it. We&apos;ll remove leaves,
            branches, and other debris to keep your yard looking its best.
          </article>
          <article className={styles.service}>
            <span className={styles.bold}>Other Yard Services:</span> We also
            offer a variety of other yard services. Whether you need help with
            planting, mulching, fertilizing, or any other yard care tasks,
