    ...
    <main className={styles.main}>
      ...
      <section className={`${styles.servicesContainer} ${styles.center} ${styles.textSize}`}>
        ...
        <div className={styles.services}>
          ...
          <article className={styles.service}><span className={styles.bold}>Trimming Hedges:</span> Well-trimmed hedges not only look good but also contribute to the overall health of the plants. Our team has the skills and equipment to trim your hedges to perfection.</article>
